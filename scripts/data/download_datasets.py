...
DEST_PATHS = {
    "train_taco.json": os.path.expanduser("/workspace/rllm/rllm/data/train/code/taco.json"),
    "olympiad.json": os.path.expanduser("/workspace/rllm/rllm/data/train/math/olympiad.json"),
    "test_livecodebench.json": os.path.expanduser("/workspace/rllm/rllm/data/test/code/livecodebench.json"),
    "train_livecodebench.json": os.path.expanduser("/workspace/rllm/rllm/data/train/code/livecodebench.json"),
    "kodcode.json": os.path.expanduser("/workspace/rllm/rllm/data/train/code/kodcode.json"),
    "primeintellect.json": os.path.expanduser("/workspace/rllm/rllm/data/train/code/primeintellect.json"),
}
